        ...
        <div className='flex bg-cover min-h-screen flex-col gap-4 bg-gradient-to-br from-indigo-900 to-blue-500 pb-8 text-gray-900 sm:gap-8'>
            ...
            {selectedCinemaIndex !== null &&
                (cinemas[selectedCinemaIndex]?.theaters?.length ? (
                    <div className='mx-4 flex flex-col gap-2 rounded-lg bg-slate-800 from-indigo-200 to-blue-100 p-4 drop-shadow-xl sm:mx-8 sm:gap-4 sm:p-6'>
                        ...
                        {auth.role === 'admin' && (
                            <form
                                className='flex flex-col lg:flex-row gap-4 text-gray-300 rounded-md bg-slate-600 from-indigo-100 to-white p-4'
                            ...
                            >
                                <div className='flex grow flex-col gap-2 rounded-lg'>
                                    <div className='flex flex-col gap-2 rounded-lg lg:flex-row lg:items-stretch'>
                                        <div className='flex grow items-center gap-x-2 gap-y-1 lg:flex-col lg:items-start'>
                                            ...
                                            <select
                                                className='h-9 w-full rounded bg-slate-700 px-2 py-1 font-semibold text-white drop-shadow-sm'
                                                required
                                                {...register('theater', {
                                                    required: true,
                                                })}
                                        ...
                                        <div className='flex grow-[2] items-center gap-x-2 gap-y-1 lg:flex-col lg:items-start'>
                                            ...
                                            <Select
                                                ...
                                                classNames={{
                                                    menuButton: (value) =>
                                                        'flex font-semibold text-sm text-white border border-slate-700 rounded shadow-sm transition-all duration-300 focus:outline-none bg-slate-700 hover:border-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-500/20',
                                                }}
                                            />
                                        </div>
                                    ...
                                    <div className='flex flex-col gap-2 rounded-lg lg:flex-row lg:items-stretch'>
                                        ...
                                        >
                                            ...
                                            <input
                                                type='time'
                                                className='h-9 w-full rounded bg-slate-700 px-2 py-1 font-semibold text-white drop-shadow-sm disabled:bg-gray-300'
                                                disabled={
                                                    !watch('autoIncrease')
                                                }
                                                {...register('gap')}
                                ...
                                <button
                                    ...
                                    className='whitespace-nowrap rounded-md bg-slate-800 from-indigo-600 to-blue-500 px-4 py-1 font-medium text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400'
                                    type='submit'
                                >
                                    +
                                </button>
                    ...
                    <div className='mx-4 flex flex-col gap-2 rounded-lg bg-gradient-to-br from-indigo-200 to-blue-100 p-4 drop-shadow-xl sm:mx-8 sm:gap-4 sm:p-6'>
                        <p className='text-center'>
                            There are no theaters available
                        </p>
                    </div>
                ))}
        </div>
