...
const Movie = () => {
    ...
    const onAddMovie = async (data) => {
        try {
            data.length =
                (parseInt(data.lengthHr) || 0) * 60 +
                (parseInt(data.lengthMin) || 0);
            ...
            <div className='mx-4 flex h-fit flex-col gap-4 rounded-md bg-gradient-to-br from-indigo-200 to-blue-100 p-4 drop-shadow-xl sm:mx-8 sm:p-6'>
                ...
                >
                    ...
                    <div className='flex w-full flex-col gap-4 lg:w-auto lg:flex-row'>
                        ...
                        <button
                            className='w-full min-w-fit items-center rounded-md bg-gradient-to-br text-black bg-gray-800 px-2 py-1 text-center font-medium drop-shadow-md hover:from-indigo-500 hover:to-blue-500 disabled:from-slate-500 disabled:to-slate-400 lg:w-24 xl:w-32 xl:text-xl'
                            type='submit'
                            disabled={isAddingMovie}
                        >
                            {isAddingMovie ? 'Processing...' : '+'}
                        </button>
                    </div>
                </form>
