...
const Theater = ({
        ...
        try {
            ...
            if (data.autoIncrease) {
                ...
                if (data.rounding5 || data.rounding10) {
                    ...
                    setValue(
                        'showtime',
                        `${String(nextShowtime.getHours()).padStart(
                            2,
                            '0',
                        )}:${String(nextShowtime.getMinutes()).padStart(
                            2,
                            '0',
                        )}`,
                    );
    ...
    return (
        <div className='flex flex-col'>
                    ...
                    <div className='flex w-fit flex-col gap-x-3 rounded-tr-2xl bg-gradient-to-br from-indigo-800 to-blue-700 px-4 py-0.5 font-semibold text-white md:flex-row md:gap-x-6 md:rounded-t-2xl md:text-lg md:font-bold'>
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            {theater?.seatPlan?.column === 1 ? (
                                ...
                                <h4>
                                    Column : 1 - {theater?.seatPlan?.column}
                                </h4>
                            )}
                        </div>
                        <div className='flex items-center gap-2'>
                            ...
                            {(
                                rowToNumber(theater.seatPlan.row) *
            ...
            <div className='flex flex-col gap-4 rounded-b-md rounded-tr-md bg-slate-600 text-gray-300 from-indigo-100 to-white py-4 md:rounded-tr-none'>
                {auth.role === 'admin' && (
                    <>
                        <form
                        ...
                        >
                            <div className='flex grow flex-col gap-2 rounded-lg'>
                                <div className='flex flex-col gap-2 rounded-lg lg:flex-row lg:items-stretch'>
                                    <div className='flex grow-[2] items-center gap-x-2 gap-y-1 lg:flex-col lg:items-start'>
                                        ...
                                        <Select
                                            ...
                                            classNames={{
                                                menuButton: (value) =>
                                                    'flex font-semibold text-sm border border-slate-500 rounded shadow-sm transition-all duration-300 focus:outline-none bg-slate-500 hover:border-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-500/20',
                                            }}
                                        />
                                    </div>
                                    <div className='flex items-center gap-x-2 gap-y-1 lg:flex-col lg:items-start'>
                                        ...
                                        <input
                                            type='time'
                                            className='h-9 w-full rounded bg-slate-500 px-2 py-1 font-semibold text-white drop-shadow-sm'
                                            required
                                            {...register('showtime', {
                                                required: true,
                                            })}
                                ...
                                <div className='flex flex-col gap-2 rounded-lg lg:flex-row lg:items-stretch'>
                                    ...
                                    <label className='flex items-center gap-x-2 gap-y-1 whitespace-nowrap text-lg font-semibold leading-5 lg:flex-col lg:items-start'>
                                        ...
                                        <input
                                            type='checkbox'
                                            className='h-6 w-6 lg:h-9 lg:w-9 bg-slate-500'
                                            {...register('isRelease')}
                                        />
                                    </label>
                                    ...
                                    >
                                        ...
                                        <input
                                            type='time'
                                            className='h-9 w-full rounded bg-slate-500 px-2 py-1 font-semibold text-white drop-shadow-sm disabled:bg-gray-300'
                                    ...
                                    <div className='flex flex-col items-start gap-2 lg:flex-row lg:items-end'>
                                        ...
                                        >
                                            ...
                                            <input
                                                type='number'
                                                step='0.01'
                                                className='h-9 w-full rounded text-white bg-slate-500 px-2 py-1 font-semibold drop-shadow-sm disabled:bg-gray-300'
                                                disabled={
                                                    !watch('autoIncrease')
                                                }
                                                {...register('price', {
                            ...
                            <button
                                ...
                                className='whitespace-nowrap rounded-md bg-gradient-to-r from-indigo-600 to-blue-500 px-4 py-1 font-medium text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400'
                                type='submit'
                            >
                                +
                            </button>
