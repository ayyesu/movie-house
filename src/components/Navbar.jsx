        ...
        return (
            <>
                <div className='flex flex-col gap-2 lg:flex-row'>
                    <Link
                        to={'/cinema'}
                        className={`flex items-center justify-center gap-2 rounded-md px-2 py-1 text-white hover:bg-gray-700 ${
                    ...
                    {auth.role && (
                        <Link
                            to={'/ticket'}
                            className={`flex items-center justify-center gap-2 rounded-md px-1 py-1 text-white hover:bg-gray-700 ${
                    ...
                    {auth.role === 'admin' && (
                        <div className='flex gap-2 lg:justify-end'>
                            ...
                            >
                                ...
                                <p className='text-lg'>Manage Showtimes</p>
                            </Link>
                            <Link
                                to={'/user'}
                                className={`flex items-center justify-center gap-2 rounded-md px-2 py-1 text-white hover:bg-gray-500 ${
        ...
        <nav className='flex flex-col items-center justify-between gap-2 bg-gray-900 px-4 py-3 drop-shadow-lg lg:flex-row lg:justify-start sm:px-8'>
            <div className='flex w-full flex-row justify-between lg:w-fit'>
                ...
                >
                    ...
                    <h1 className='mr-2 text-xl text-white italic'>
                        Movie Life Court
                    </h1>
                </button>
                <button
