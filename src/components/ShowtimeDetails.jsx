...
const ShowtimeDetails = ({showDeleteBtn, showtime, fetchShowtime}) => {
    ...
    const handleReleaseShowtime = () => {
        const confirmed = window.confirm(
            `Do you want to release this showtime?`,
        );
        if (confirmed) {
            onReleaseShowtime();
        }
    ...
    return (
        <>
            ...
            <div className='flex flex-col md:flex-row'>
                <div className='flex grow flex-col gap-4 bg-slate-600 text-white from-indigo-100 to-white py-2 drop-shadow-lg sm:py-4'>
