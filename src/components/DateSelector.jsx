...
const DateSelector = ({selectedDate, setSelectedDate}) => {
    ...
    console.log('form date', formatDate(selectedDate));

    return (
        <div className='flex flex-col gap-2'>
            <div className='relative flex items-stretch justify-between gap-2 rounded-md bg-slate-800 p-2 font-semibold text-white'>
                {auth.role === 'admin' ||
