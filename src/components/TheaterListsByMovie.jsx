...
const TheaterListsByMovie = ({
        ...
        try {
            ...
            setTheaters(
                response.data.data.sort((a, b) => {
                    ...
                    if (a.cinema.name === b.cinema.name && a.number > b.number)
                        return 1;
                    return -1;
                }),
            );
    ...
    return (
        <>
            <CinemaLists {...props} />
            <div className='mx-4 h-fit rounded-md bg-slate-800 text-gray-400 drop-shadow-md sm:mx-8'>
                <div className='flex flex-col gap-6 p-4 sm:p-6'>
                    <DateSelector
                        selectedDate={selectedDate}
                        setSelectedDate={setSelectedDate}
                    />
                    <div className='flex flex-col gap-4 rounded-md bg-slate-800 from-indigo-100 to-white py-4'>
                        <div className='flex items-center'>
                            ...
                            <div>
                                ...
                                <p className='text-md font-medium'>
                                    length :{' '}
                                    {movies[selectedMovieIndex].length || '-'}{' '}
                                    min
                                </p>
                            </div>
                        </div>
                                ...
                                return (
                                    <div
                                        ...
                                        className={`flex flex-col ${
                                            index !== 0 &&
                                            filteredTheaters[index - 1]?.cinema
                                                .name !==
                                                filteredTheaters[index].cinema
                                                    .name &&
                                            'mt-6'
                                        }`}
                                    >
                                        {filteredTheaters[index - 1]?.cinema
                                            ...
                                            filteredTheaters[index].cinema
                                                .name && (
                                            <div className='rounded-t-md bg-slate-400 from-indigo-800 to-blue-700 px-2 py-1.5 text-center text-2xl font-semibold text-white sm:py-2'>
                                        ...
                                        <TheaterShort
                                            ...
                                            rounded={
                                                ...
                                                filteredTheaters[index + 1]
                                                    ?.cinema.name !==
                                                    filteredTheaters[index]
                                                        .cinema.name
                                            }
                                        />
                                    </div>
