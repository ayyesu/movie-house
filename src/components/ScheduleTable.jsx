        ...
        cinema.theaters.forEach((theater, index) => {
            theater.showtimes.forEach((showtime, index) => {
                if (
                    ...
                    new Date(showtime.showtime).getMonth() ===
                        selectedDate.getMonth() &&
                    new Date(showtime.showtime).getYear() ===
                    ...
                    if (
                        rowStart + getRowSpan(showtime.movie.length) >
                        lastRowEnd
                    ) {
                        lastRowEnd =
                            rowStart + getRowSpan(showtime.movie.length);
        ...
        <>
            ...
            >
                {cinema.theaters?.map((theater, index) => {
                    {
                        return getTodayShowtimes(theater)?.map(
                            (showtime, index) => {
                                return (
                                    <button
                                        title={`${
