...
const TheaterListsByCinema = ({
    ...
    const onDecreaseTheater = async () => {
        try {
            ...
            const response = await axios.delete(
                `/theater/${
                    cinemas[selectedCinemaIndex].theaters.slice(-1)[0]._id
                }`,
                {
                    headers: {
                        Authorization: `Bearer ${auth.token}`,
    ...
    return (
        <div className='mx-4 h-fit rounded-md bg-slate-800 from-indigo-200 to-blue-100 text-gray-900 drop-shadow-md sm:mx-8'>
                ...
                {auth.role === 'admin' && (
                    <>
                        ...
                        <button
                            ...
                            onClick={() =>
                                handleDelete(cinemas[selectedCinemaIndex])
                            }
                        >
                            {isDeleting ? (
                                'Processing...'
            ...
            <div className='flex flex-col gap-6 p-4 sm:p-6 overflow-y-auto'>
                ...
                >
                    <h2 className='text-2xl text-white font-bold'>Theaters</h2>
                    {auth.role === 'admin' && (
                        <div className='flex w-full flex-wrap justify-between gap-4 rounded-md bg-slate-600 from-indigo-100 to-white p-4'>
